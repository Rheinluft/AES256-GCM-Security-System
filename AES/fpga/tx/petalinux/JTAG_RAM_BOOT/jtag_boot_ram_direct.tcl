...
set bit_file [file join $root vivado artifacts AES_GCM_TX.bit]
set ps_init [file join $root vivado artifacts ps7_init.tcl]
set fsbl [file join $here fsbl.elf]
...
if {[info exists ::env(AES_GCM_TX_CABLE_SERIAL)] &&
    [string trim $::env(AES_GCM_TX_CABLE_SERIAL)] ne ""} {
    set cable_serial [string trim $::env(AES_GCM_TX_CABLE_SERIAL)]
    ...
    set cable_serial "210351BE7DF5A"
}
